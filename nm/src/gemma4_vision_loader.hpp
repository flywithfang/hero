...
inline Gemma4E4BVisionEncoder::Layer load_layer(const GGUF& gguf, size_t layer) {
    ...
    return Gemma4E4BVisionEncoder::Layer(norm("ln1.weight"), load_clipped<C::D, C::D>(gguf, block(layer, "attn_q")), load_clipped<C::D, C::D>(gguf, block(layer, "attn_k")), load_clipped<C::D, C::D>(gguf, block(layer, "attn_v")), load_clipped<C::D, C::D>(gguf, block(layer, "attn_out")), PerHeadNorm<C::H, C::HEAD_DIM, RMSNorm<C::HEAD_DIM>>(head_norm("attn_q_norm.weight")), PerHeadNorm<C::H, C::HEAD_DIM, RMSNorm<C::HEAD_DIM>>(head_norm("attn_k_norm.weight")), RMSNormNoScale<C::HEAD_DIM>(C::EPS), norm("attn_post_norm.weight"), norm("ln2.weight"), load_clipped<C::D, C::FF>(gguf, block(layer, "ffn_gate")), load_clipped<C::D, C::FF>(gguf, block(layer, "ffn_up")), load_clipped<C::FF, C::D>(gguf, block(layer, "ffn_down")), norm("ffn_post_norm.weight"));
}
